...
import ProductDetailsSubItems from "./productDetailsSub/productDetailsSub";
...
const ProductDetails = () => {
  return (
    <div className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
      ...
      >
        Discover the Latest Trends at TrendsTrove
      </a>
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-7xl">
        Explore Unique Products on TrendsTrove
        ...
        <span className="relative whitespace-nowrap text-blue-500 dark:text-orange-300">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute top-2/3 left-0 h-[0.58em] w-full fill-black dark:fill-orange-300/60"
          ...
          <span className="uppercase relative">Trending Products</span>
        </span>
      </h1>
      <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
        Discover the future of shopping with TrendsTrove. From trendy fashion to
        cutting-edge electronics, our platform showcases a wide range of unique
        products curated just for you.
      </h2>
      <a
        className="bg-black dark:bg-gray-800 rounded-xl text-white dark:text-gray-300 font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-orange-500  transition"
        href=""
      >
        Explore Now
      </a>
      <ProductDetailsSubItems />
    </div>
  );
};
